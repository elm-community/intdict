...
queryTests =
  describe "query"
    ...
    , test "before 6" <| \() -> Expect.equal (Just (5, "3")) (IntDict.before 6 moreNumbers)
    , test "before 7" <| \() -> Expect.equal (Just (5, "3")) (IntDict.before 7 moreNumbers)
    ...
    , test "after 2'" <| \() -> Expect.equal (Just (5, "3")) (IntDict.after 2 moreNumbers)
